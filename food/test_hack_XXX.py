...
#     def build(self):
#         img = Image(source='/Users/marine/hackherthon/selfie.png',
#                      size_hint=(1, .5),
...
#make something explode on the image 
import random
import math
import arcade
...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        self.background = arcade.load_texture("/Users/marine/hackherthon/selfie.png")
